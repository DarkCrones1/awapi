...
// public class LoginCraftmanController : ControllerBase
// {
//     private readonly IMapper _mapper;
//     private readonly IAuthenticationService _service;
//     private readonly IUserAccountService _userAccountService;
//     private readonly IConfiguration _configuration;
//     protected ActiveUserAccountCraftman _user;

//     public LoginCraftmanController(IMapper mapper, IAuthenticationService service, IUserAccountService userAccountService, IConfiguration configuration)
//     {
//         this._mapper = mapper;
//         this._service = service;
//         this._userAccountService = userAccountService;
//         this._configuration = configuration;
//         _user = new ActiveUserAccountCraftman();
...
//                 new Claim("CraftmanId", $"{_user.CraftmanId}")
//             };
